...
const Countdown = ({ countdownTimestampMs, message }) => {
	...
	return isCountdownFinished ? (
		...
		<>
			...
			<div className='countdown'>
				...
				<p className='days'>{remainingTime.day}</p>
				<p className='hours'>{remainingTime.hour}</p>
				<p className='minutes'>{remainingTime.minute}</p>
				<p className='seconds'>{remainingTime.second}</p>
			</div>
		</>
	);
};
