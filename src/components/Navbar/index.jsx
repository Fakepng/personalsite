        ...
        <>
            <div className="navbardiv">
                <header className="navbar">
                    <NavLink className="navlogo" to="/" exact='true'><img src="/images/fakepng.svg" height="60px" /></NavLink>
            ...
            <div className={click ? 'Mobile' : 'MobileClose'}>
                ...
                <NavLink className="mobilelink" onClick={handleClick} activeclassname="active" to='/about'>About</NavLink>
                <NavLink className="mobilelink" onClick={handleClick} activeclassname="active" to='/education'>Education</NavLink>
                <NavLink className="mobilelink" onClick={handleClick} activeclassname="active" to='/project'>Project</NavLink>
            </div>
        </>
    )
}
